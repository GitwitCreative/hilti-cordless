 ...
 *
 * EDITED BY scremer@fork.de ON 2016-02-15 WITH POTENTIAL SURFACE HISTORY FIX
 *
 */
(function(global, factory) {
    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        /** [2016-02-15 scremer@fork.de] Surface Landscape Check **/
        var isMsSurfaceLandscape = false;
        if(window.innerWidth > window.innerHeight) {
            //console.log('### Is landscape ###', navigator);
            isMsSurfaceLandscape = ( navigator.userAgent.match(/Windows/) && navigator.userAgent.match(/Windows Phone/) == null && (isTouchDevice || isTouch) );
            //console.log('### is surface landscape? ###', isMsSurfaceLandscape);
        }
        /** /[2016-02-15 scremer@fork.de] Surface Landscape Check **/
        var container = $(this);
        ...
        */
        function setUrlHash(url){
            if(options.recordHistory){
                ...
                if( (isTouchDevice || isTouch) && !isMsSurfaceLandscape ){
