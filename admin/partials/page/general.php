<div class="mdl-color--white mdl-shadow--2dp mdl-color-text--grey-800 mdl-cell mdl-cell--8-col">
  ...
  <form action="?action=<?php echo $page_action; ?>&amp;site=<?php echo get_current_site(); ?>&amp;page=<?php echo get_current_page_name(); ?>" method="POST">
      ...
      <div class="__content__page-type __form__radio-button">
        ...
        <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="page__type--1">
          <input type="radio"
              ...
              <?php if ($SITE['page']->general->type == 'content') { echo 'checked'; } ?>>
        ...
        <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="page__type--2">
          <input type="radio"
              ...
              data-js-content-toggle-input="general[type]"
              data-js-content-toggle-target=".js-content-toggle"
              <?php if ($SITE['page']->general->type == 'video') { echo 'checked'; } ?>>
