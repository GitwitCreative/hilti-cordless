            ...
            <div class="mdl-color--white mdl-shadow--2dp mdl-color-text--grey-800 mdl-cell mdl-cell--4-col">
                ...
                <div class="mdl-card__actions mdl-card--border">
                    ...
                    <form action="?action=<?php echo $page_action; ?>&amp;site=<?php echo get_current_site(); ?>"
                        ...
                        switch ($page->name) {
                            case 'categories' :
                                $url = "?action=categories&amp;site=" . get_current_site();
                                break;
                            case 'products':
                                $url = "?action=products&amp;site=" . get_current_site();
                                break;
                            default:
                                $url = "?action=page&amp;site=" . get_current_site() . "&amp;page=" . $page->name;
                        }
                        ?>
                        <a
                            href="<?php echo $url; ?>"
                        ...
                        <?php if (!in_array($page->name, ['categories', 'products'])) : ?>
